...
describe('CronjobService', () => {
  ...
  it('does not schedule cronjob that is too far in the future', async () => {
    ...
    // eslint-disable-next-line dot-notation
    expect(cronjobController['_timers'].size).toBe(0);
  ...
  it('handles SnapInstalled event', async () => {
    ...
    // eslint-disable-next-line dot-notation
    expect(cronjobController['_snapIds'].size).toBe(2);
  ...
  it('handles SnapRemoved event', async () => {
    ...
    // eslint-disable-next-line dot-notation
    expect(cronjobController['_snapIds'].size).toBe(0);
  ...
  it('handles SnapUpdated event', async () => {
    ...
    expect(cronjobController['_snapIds'].size).toBe(2);
    // eslint-disable-next-line dot-notation
    expect(cronjobController['_timers'].size).toBe(2);
    ...
    // eslint-disable-next-line dot-notation
    expect(cronjobController['_snapIds'].size).toBe(1);
    // eslint-disable-next-line dot-notation
    expect(cronjobController['_timers'].size).toBe(1);
